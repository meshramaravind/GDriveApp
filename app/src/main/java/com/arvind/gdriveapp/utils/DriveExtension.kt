...
import com.arvind.gdriveapp.utils.Constants.DEBUG_TAG
 ...
 */
suspend fun Drive.fetchOrCreateAppFolder(
    folderName: String,
    ...
    return if (folderList.files.isEmpty()) {
        ...
        Log.e(DEBUG_TAG, folderList.getFirst().id)
        preferenceHelper.setFolderID(folderList.getFirst().id)
